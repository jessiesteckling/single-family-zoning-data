...
`python3 main.py` rewrites both of them and the CSV. It re-downloads both datasets from
...
Tests: `python3 -m unittest discover -s tests -t .` — 26 unit tests over literal mock
portal responses, no network required.
