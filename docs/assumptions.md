...
| D7 | `DS` allows no residential | **Broken** | Downtown Service carries a residential density standard (400 sq ft per unit, 300 efficiency, 200 SRO) and a 30 ft setback for floors containing dwelling units. 0.26% of land, and `report.py` prints the claim. H3 |
